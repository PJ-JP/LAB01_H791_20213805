...
import com.example.laboratorio.repository.EmployeeRepository;
...
public class EmployeeController {
    ...
    final EmployeeRepository shipperRepository;

    public EmployeeController(EmployeeRepository shipperRepository) {
    ...
    public String listarTransportistas(Model model) {
        ...
        List<Employee> lista = shipperRepository.findAll();
    ...
    @PostMapping("/save")
    public String guardarNuevoTransportista(Employee shipper, RedirectAttributes attr) {
    ...
    public String editarTransportista(Model model,
        ...
        Optional<Employee> optShipper = shipperRepository.findById(id);

        if (optShipper.isPresent()) {
            Employee shipper = optShipper.get();
    ...
    public String buscarTransportista(@RequestParam("searchField") String searchField,
        ...
        List<Employee> listaTransportistas = shipperRepository.buscarTransPorCompName(searchField);
